  ...
  render() {
    return (
      <StyledEventDark>
        ...
        <LoadingButton disabled={this.state.loading} hidden={this.state.event === '' || this.state.event === 'sell'} onClick={() => this.submit()} variant='contained' pending={this.state.loading} pendingPosition='center'>Adicionar</LoadingButton>
      </StyledEventDark>
    )
  }
}
